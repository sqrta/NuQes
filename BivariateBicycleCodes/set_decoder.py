...
# [[270, 24, 10]]
# l,m = 9, 15
# Aterm = 'x3+x6+y3'.split('+')
# Bterm = 'x0+y1+y5'.split('+')

# [[144,12,12]]
# ell,m = 12,6
# a1,a2,a3 = 3,1,2
# b1,b2,b3 = 3,1,2
# Aterm = 'x3+y1+y2'.split('+')
# Bterm = 'y3+x1+x2'.split('+')
...
# [[170, 16, 10]] , 
# ell,m = 17,5
# Aterm = 'x1+x16+y1'.split('+')
# Bterm = 'x4+x13+y4'.split('+')

# Aterm = 'x6+x11+y4'.split('+')
# Bterm = 'x7+x10+y1'.split('+')

# [[168, 18, 8]]
# ell, m = 7,12
# Aterm = 'x2+x6+y3'.split('+')
# Bterm = 'x1+x3+y6'.split('+')

# [[168, 18, 8]]
# ell, m = 4,21
# Aterm = 'x1+y3+y9'.split('+')
# Bterm = 'x2+y12+y15'.split('+')

# [[112, 12, 8]]
# ell, m = 7,8
# Aterm = 'x2+y8+y12'.split('+')
# Bterm = 'x3+y9+y10'.split('+')
...
# [[90,8,10]]
# ell, m = 15,3
# Aterm = 'x0+x1+x5'.split('+')
# Bterm = 'x3+y1+y2'.split('+')

# [[240, 16, 12]]
# ell, m = 20,6
# Aterm = 'x1+x4+y1'.split('+')
# Bterm = 'x4+x6+y4'.split('+')

# [[84, 18, 4]]
# ell, m = 3,14
# Aterm = 'x0+y1+y3'.split('+')
# Bterm = 'x0+y1+y10'.split('+')

# [[210, 30, 6]]
# ell, m = 15,7
# Aterm = 'x5+y2+y6'.split('+')
# Bterm = 'x10+y2+y6'.split('+')

# [[144, 16, 8]]
# ell, m = 3,24
# Aterm = 'x0+y2+y10'.split('+')
# Bterm = 'x1+x2+y18'.split('+')

# [[240,16,12]] good
# ell,m = 4,30
# Aterm = 'x1+y1+y12'.split('+')
...
a1, a2, a3 = (int(p[1:]) for p in Aterm)
b1, b2, b3 = (int(p[1:]) for p in Bterm)

A1 = Str2M(Aterm[0],x,y)
A2 = Str2M(Aterm[1],x,y)
A3 = Str2M(Aterm[2],x,y)
B1 = Str2M(Bterm[0],x,y)
B2 = Str2M(Bterm[1],x,y)
B3 = Str2M(Bterm[2],x,y)
