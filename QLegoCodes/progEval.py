...
def eval_prog(prog, px, pz):
    ...
    if error == 0:
        ...
        print(
            f"n: {n}, k: {k}, d: {d}, Ks: {K}, rW: {rw}, cW: {cw}, error: {error:.5e}"
        )
    ...
    # print(
    #     f"ABzx: {ABzx(stab_group, px, 1 - px, pz, 1- pz, k, K)}, d: {distance(code, k, stab_group)}"
    # )

    # print(eval_tn(tn))
    return code, n, k, d, tmp.matrix
...
prog15_14 = (
    ...
    ["code603", "code604", "code604", "code604"],
)
...
progStean = (
    [["trace", 0, 0, 1, 0], ["self", 0, 1, 1, 1], ["setLog", 0, 2]],
    ["code603", "code603"],
)
...
prog713_4_4 = (
    ...
    ["code603", "code604", "codeH", "codeH", "codeS"],
)
...
prog813_44 = (
    ...
    ["code604", "code603", "codeH", "codeH", "codeS", "codeGHZ"],
)
prog813_57 = (
    [
        ["trace", 0, 0, 1, 0],
    ...
    ["code604", "code603", "codeH", "codeS", "codeS", "codeGHZ"],
)
prog813_66 = (
    [
        ["trace", 0, 0, 1, 0],
    ...
    ["code604", "codeS", "code604", "codeS", "codeGHZ"],
)
...
prog6_1_3_55 = (
    ...
    ["code604", "codeS", "codeGHZ", "codeH", "codeH", "codeS"],
)
...
prog823_54 = (
    ...
    ["code604", "code604", "code604", "codeH", "codeS"],
)
prog823_43_2 = (
    [
        ["trace", 0, 0, 1, 0],
    ...
    ["code604", "code604", "codeH", "codeH", "code604"],
)
prog923_44 = (
    [
        ["trace", 0, 0, 1, 0],
    ...
    ["code604", "code604", "code604", "codeGHZ", "codeH"],
)

prog513_44 = (
    [["trace", 0, 0, 1, 0], ["trace", 0, 1, 2, 0], ["setLog", 0, 2]],
    ["code604", "codeS", "codeS"],
)
prog513_43 = (
    [
...
prog16_2_3 = (
    ...
    ["code603", "codeH", "code604", "code604", "code603"],
)
...
prog913_4_4 = (
    ...
    ["code804", "codeH", "codeH", "code604", "codeS"],
)
...
prog913_8_7 = (
    ...
    ["code804", "codeH", "codeS", "code604", "codeS"],
)
...
prog1013_6_7 = (
    ...
    ["code604", "code603", "codeH", "codeGHZ", "code604"],
)
...
prog12_3_106 = (
    ...
    ["code604", "code603", "codeH", "codeS", "codeGHZ", "code604"],
)
...
prog13_1_4_78 = (
    ...
    ["code604", "code603", "codeH", "code604", "code604"],
)
...
prog13_1_4_99 = (
    ...
    ["code604", "code604", "code604", "code603"],
)
...
prog11_1_3_98 = (
    ...
    ["code604", "code603", "codeH", "codeH", "code604"],
)
...
prog12_3_108 = (
    ...
    ["code604", "code603", "codeH", "codeH", "codeGHZ", "code604"],
)
...
prog7_3_66 = (
    ...
    ["code604", "code603", "codeH", "codeS", "codeS", "codeH"],
)


tnList = (
    ["code603", "code0", "codePlus"]
    + ["code603", "code0"]
    + ["code603", "code0", "codePlus"]
    + ["code603", "codePlus"]
    + ["code603"]
